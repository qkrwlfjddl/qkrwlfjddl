...
|    | Project                                                                                      | Stack                                |
| -- | -------------------------------------------------------------------------------------------- | ------------------------------------ |
| 📈 | **[Business Data & AI Dashboard](https://github.com/qkrwlfjddl/Business-Data-AI-Dashboard)** | `BigQuery` `Airflow` `Gemini` `RAG`  |
| 🔄 | **[HANA → BigQuery Pipeline](https://github.com/qkrwlfjddl/HANA-BQ-ApacheAirflow)**          | `Python` `SQL` `Airflow` `Cloud Run` |
| 📊 | **[Marketing KPI & AI Insight](https://github.com/qkrwlfjddl/Marketing-KPI-AI-Insight)**     | `GA4` `BigQuery ML` `Vertex AI`      |
